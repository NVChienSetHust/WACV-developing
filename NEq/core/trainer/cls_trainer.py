...
class ClassificationTrainer(BaseTrainer):
    def validate(self, split):
        ...
        with torch.no_grad():
            ...
            if split == "test":
                # uncomment if we need to load the best validation model to test at the end of the training loop
                # # Load the best validation model before test
                # self.load_best_validation_model()
